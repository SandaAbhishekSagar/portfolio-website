...
total += emit(
  ...
  'Voice AI, RAG Engineer and Conversational AI Engineer - Resume - Abhishek Sagar Sanda - Boston',
...
total += emit(
  ...
  'Full-Stack AI Engineer in Boston - Abhishek Sagar Sanda',
...
for (const p of PROJECTS) {
  ...
  total += emit(
    route,
    renderToString(createElement(StaticApp, { route })),
    `${p.title} - Voice AI, RAG Engineer and Conversational AI Engineer - ${PROFILE.name} - Boston`,
    p.summary.replace(/"/g, '&quot;')
  );
  pages++;
}
