...
total += emit(
  ...
  'Voice AI, RAG Engineer and Conversational AI - Abhishek Sagar Sanda - Boston',
...
total += emit(
  ...
  'Voice AI, RAG Engineer and Conversational AI - Resume - Abhishek Sagar Sanda - Boston',
...
for (const p of PROJECTS) {
  ...
  total += emit(
    route,
    renderToString(createElement(StaticApp, { route })),
    `${p.title} - Voice AI, RAG Engineer and Conversational AI - ${PROFILE.name} - Boston`,
    p.summary.replace(/"/g, '&quot;')
  );
  pages++;
}
